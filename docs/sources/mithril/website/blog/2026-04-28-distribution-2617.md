...
This distribution also supports Cardano node `11.0.1`.
...
- **Cardano node support**: added support for Cardano node `10.6.2` and `10.7.1` in the signer, aggregator, and client. Cardano node `11.0.1` is also supported
